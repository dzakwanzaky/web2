...
class mahasiswa extends Controller
{
    ...
    public function edit($id)
    {
        ...
        return view('mhs_edit',compact('data'));
    }
    ...
    public function update(Request $request, $id)
    {
          ...
          $data->password = $request->password;
  		  $data->save();
		 return redirect()->route('mahasiswa.index')->with('alert-success','Data Updated!');
    }
    ...
    public function destroy($id)
    {
        $data = ModelMahasiswa::where('id',$id)->first();
        $data->delete();
		return redirect()->route('mahasiswa.index')->with('alert-success','Data Deleted!');
